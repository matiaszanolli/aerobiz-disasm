...
func_017906:
    ...
    pea     ($0004).w
    pea     ($000A).w
    dc.w    $4EBA,$0330                                 ; jsr $017C6E(pc)
    nop
    dc.w    $4EBA,$01C6                                 ; jsr $017B0A(pc)
    nop
    move.w  (a4), d0
    lsl.w   #$2, d0
    movea.l  #$00047A88,a0
...
l_1aa52:
    ...
    dc.w    $4E56,$FFFC,$48E7,$3F30; $01AA58
...
func_01B91A:
    ...
    ext.l   d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$11FC                                 ; jsr $01CB82(pc)
    nop
    move.w  d2, d0
    ext.l   d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$0AAA                                 ; jsr $01C43C(pc)
    nop
    movem.l -$c(a6), d2-d3
    unlk    a6
    rts
...
.l1e1a2:                                                ; $01E1A2
    rts
; ---------------------------------------------------------------------------
    dc.w    $2F0A,$246F,$0008,$226F,$000C,$204A,$14D9,$66FC; $01E1A4
    dc.w    $2008,$245F,$4E75                                       ; $01E1B0
; ============================================================================
...
; ============================================================================
; func_01E402 -- (TODO: name)
; 184 bytes | $01E402-$01E4B9
; ============================================================================
func_01E402:
    move.l  d2, -(a7)
    dc.w    $4EBA,$00E6                                 ; jsr $01E4EC(pc)
    nop
    clr.w   d2
l_1e40c:
    moveq   #$0,d0
    move.w  d2, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$057A                                 ; jsr $01E98E(pc)
    nop
    addq.l  #$4, a7
    addq.w  #$1, d2
    cmpi.w  #$7, d2
    bcs.b   l_1e40c
    dc.w    $4EBA,$0096                                 ; jsr $01E4BA(pc)
    nop
    tst.w   d0
    beq.b   l_1e432
    dc.w    $4EB9,$0001,$D748                           ; jsr $01D748
...
l_1e488:
    ...
    move.w  d2, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$2128                                 ; jsr $0205B8(pc)
    nop
    addq.l  #$4, a7
    addq.w  #$1, d2
    cmpi.w  #$4, d2
    bcs.b   l_1e488
    dc.w    $4EBA,$03B4                                 ; jsr $01E854(pc)
    nop
    dc.w    $4EBA,$244C                                 ; jsr $0208F2(pc)
    nop
...
l_1e5b4:
    ...
    cmpi.w  #$4, d3
    bcs.w   l_1e514
    dc.w    $4EBA,$000A                                 ; jsr $01E5D2(pc)
    nop
    movem.l (a7)+, d2-d4/a2-a5
    rts

; ============================================================================
; func_01E5D2 -- (TODO: name)
...
l_1ecf0:
    ...
    move.w  d2, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$064E                                 ; jsr $01F352(pc)
    nop
    pea     ($0007).w
    dc.w    $4EBA,$042E                                 ; jsr $01F13C(pc)
    nop
    lea     $c(a7), a7
l_1ed16:
    moveq   #$0,d0
...
l_1ee76:
    ...
    move.w  d3, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$0DCC                                 ; jsr $01FC50(pc)
    nop
    moveq   #$0,d0
    move.w  d4, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$02AC                                 ; jsr $01F13C(pc)
    nop
    addq.l  #$8, a7
l_1ee96:
    addq.w  #$1, d3
...
l_1eefc:
    ...
    move.w  d3, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$0D4C                                 ; jsr $01FC50(pc)
    nop
l_1ef08:
    moveq   #$0,d0
    move.w  d4, d0
    move.l  d0, -(a7)
    dc.w    $4EBA,$022C                                 ; jsr $01F13C(pc)
    nop
    lea     $c(a7), a7
l_1ef18:
    addq.w  #$1, d3
