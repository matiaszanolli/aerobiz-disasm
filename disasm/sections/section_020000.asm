...
func_022682:
    ...
    lea     (a0,d0.w), a0
    movea.l a0, a3
    dc.w    $4EB9,$0002,$3D80                           ; jsr $023D80
    pea     ($0005).w
    move.l  a3, d0
    addq.l  #$3, d0
    move.l  d0, -(a7)
...
l_228dc:
    ...
    dc.w    $4EB9,$0002,$3DB6                           ; jsr $023DB6
    clr.l   -(a7)
    pea     ($0002).w
    dc.w    $4EB9,$0002,$1FD4                           ; jsr $021FD4
    lea     $10(a7), a7
...
func_022D0A:
    ...
    dc.w    $4EB9,$0002,$3C9A                           ; jsr $023C9A
    pea     ($0001).w
    move.l  a2, d0
    addq.l  #$1, d0
    move.l  d0, -(a7)
...
l_22e92:
    ...
    dc.w    $003C
    dc.w    $0050
    dc.w    $4EB9,$0002,$3B6A                           ; jsr $023B6A
    pea     ($0001).w
    move.l  a2, d0
    addq.l  #$1, d0
    move.l  d0, -(a7)
...
l_22fdc:
    ...
    pea     ($0012).w
    clr.l   -(a7)
    dc.w    $4EB9,$0002,$3A8A                           ; jsr $023A8A
    addq.l  #$8, a7
l_22ff8:
    clr.l   -(a7)
    dc.w    $4EB9,$0002,$38F0                           ; jsr $0238F0
    ...
    beq.b   l_23088
    pea     ($0003).w
    dc.w    $4EB9,$0002,$3B10                           ; jsr $023B10
    addq.l  #$4, a7
    bra.b   l_23098
l_23088:
    pea     ($0001).w
...
l_26c8a:
    ...
    move.l  d0, -(a7)
    pea     ($000A).w
    dc.w    $4EB9,$0000,$5C64                           ; jsr $005C64
    lea     $c(a7), a7
l_26cc2:
    moveq   #$C,d0
    adda.l  d0, a3
...
l_2fa82:
    ...
    move.l  d0, -(a7)
    pea     ($0003).w
    dc.w    $4EB9,$0001,$0AB6                           ; jsr $010AB6
    lea     $24(a7), a7
    move.w  d0, d2
    ext.l   d0
    moveq   #-$1,d1
...
l_2fb0e:
    ...
    move.w  d3, d0
    move.l  d0, -(a7)
    dc.w    $4EB9,$0001,$8214                           ; jsr $018214
    bra.b   l_2fb0e
    move.w  $12(a6), d0
    move.l  d0, -(a7)
    move.w  d3, d0
    move.l  d0, -(a7)
    dc.w    $4EB9,$0001,$861A                           ; jsr $01861A
    addq.l  #$8, a7
    bra.w   l_2fa82
l_2fb42:
    movem.l -$8(a6), d2-d3
